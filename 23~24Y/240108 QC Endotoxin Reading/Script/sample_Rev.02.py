...
def show_points_and_hsv_values(image_path, output_folder, step=250):
    ...
    if img is None:
        print(f"Cannot load the image at {image_path}. Check if the file exists and is not corrupted.")
        return  # 이미지 로드에 실패했으므로 함수를 종료합니다.
...
sample_folder = "D://#.Secure Work Folder//BIG//Project//23~24년//240108 익산QC 엔도톡신 Reading//PIC//in//sample"
output_folder = "D://#.Secure Work Folder//BIG//Project//23~24년//240108 익산QC 엔도톡신 Reading//PIC//out//sample"
