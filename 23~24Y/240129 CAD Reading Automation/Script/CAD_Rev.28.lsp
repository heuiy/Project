...
(foreach area coords
  ...
  ​
  ;; PDF 플롯 설정
  (command "-PLOT" "Y" ; 상세한 플롯 구성
          "Model" ; 배치 이름
          "AutoCAD PDF (General Documentation).pc3" ; 플롯 설정 이름
          "ISO_full_bleed_A3_(420.00_x_297.00_MM)" ; 용지 크기
          "mm" ; 단위
          "Landscape" ; 방향
          "No" ; 종이 크기에 맞춤
          "Window" ; 플롯 영역
          ...
          "Center" ; 플롯 정렬
          "Yes" ; 플롯 스타일 테이블
          "monochrome.ctb" ; 플롯 스타일 테이블 파일
          "Yes" ; 플롯 개체 라인가중치
          "No" ; 플롯에 투명도 사용
          "Yes" ; 플롯 종이 그림자
          "No" ; 경계선 없음
          "Yes" ; 파일로 플롯
          (strcat outputPath "Output_" (itoa (1+ (setq i (1+ i)))) ".pdf") ; 출력 파일 이름
          "Yes" ; 파일 저장
  )
  ​
