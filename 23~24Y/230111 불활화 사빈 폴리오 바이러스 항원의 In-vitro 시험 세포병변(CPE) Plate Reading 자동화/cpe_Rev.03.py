...
def create_result_folder_and_save_images(original_folder, image_name, processed_image):
    ...
    result_folder_path = os.path.join(os.path.dirname(original_folder), result_folder)
...
if __name__ == '__main__':
    ...
    user_choice = int(input("선택한 폴더의 번호를 입력하세요: "))
    chosen_folder = folders.get(user_choice, "잘못된 선택")
    print(f"선택된 폴더: {chosen_folder}")
