...
def find_similar_circles(image, threshold_value=70):
    ...
    circles = cv2.HoughCircles(dst, cv2.HOUGH_GRADIENT, dp=1, minDist=300,
                               param1=40, param2=10, minRadius=130, maxRadius=180)
