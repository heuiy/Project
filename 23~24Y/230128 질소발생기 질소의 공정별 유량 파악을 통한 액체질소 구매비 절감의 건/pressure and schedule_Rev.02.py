...
# 신규 칼럼 추가
combined_df['DP60_on'] = (pressure_df['PI_S_205.PV_Value'] >= 0.5).astype(int)
combined_df['DP67_on'] = (pressure_df['PI_S_220.PV_Value'] >= 0.5).astype(int)
combined_df['DP72_FD3_on'] = (pressure_df['PI_S_241.PV_Value'] >= 0.5).astype(int)
combined_df['DP72_FD4_on'] = (pressure_df['PI_S_301.PV_Value'] >= 0.5).astype(int)
