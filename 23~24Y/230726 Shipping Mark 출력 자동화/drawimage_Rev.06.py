...
def copy_pages(input_pdf_path):
    ...
    if total_pages == 2:
        ...
        print("지원하지 않는 페이지 수입니다. 2페이지의 PDF만 지원됩니다.")
        return None
...
def main():
    ...
    writer = copy_pages(selected_pdf_file)  # copies는 사용되지 않으므로 1로 설정하였습니다.
