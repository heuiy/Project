...
# 
# 2. **데이터 전처리 및 증강:** 모델에 필요한 입력 형태로 데이터 처리와 데이터 증강
# 
# 4. **ResNet 모델 로드  :** ResNet 모델 불러오기
# 
# 5. **하이퍼 파라미터 설정 및 컴파일 :** 올바른 하이퍼 파라미터 설정
# 
# 6. **ResNet 모델 학습 수행:** ResNet 모델을 통한 학습 수행, 평가 및 예측 수행
# 
# 7. **제출:** 예측한 결과를 제출한 후 채점 결과를 확인
# 
# 
...
# 
#  ![00_example1](04_03_file/00_example1.png)
# 
...
# 손상 여부를 판단할 수 있을까 ?
# 
#  ![00_example2](04_03_file/00_example2.png)
...
# 손상 여부를 판단할 수 있을까 ?
# 
#  ![00_example3](04_03_file/00_example3.png)
...
# |-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|
# |01|1||||RMSprop|||||||||||0.450000|
# |02|1||||SGD|||||||||||0.525000|
# |03|1||||Adam|||||||||||0.425000|
# |04|10||||SGD|||||||||||0.325000|
# 
# accuracy 측정 결과 정확도가 0.65 이상이면 100점
# 
...
# 
#  ![02_preprocessing1](04_03_file/02_preprocessing1.png)
# 
...
# 
#  ![02_preprocessing3](04_03_file/02_preprocessing3.png)
...
# 
#  ![02_augmentation](04_03_file/02_augmentation.png)
...
# 
# ---
# ![03_average_pool](04_03_file/03_average_pool.png)
...
# 
#  ![04_lr_schedule](04_03_file/04_lr_schedule.png)
...
checkpoint_path = "resnet_training_with_aug/cp-{epoch:02d}.ckpt"
...
model.load_weights('resnet_training_with_aug/cp-01.ckpt')
...
# ---
# 
# Renset 모델에 data augmentation 기법을 적용하여 테스트 데이터(**test_batches**)를 추론해보세요.
# 
# 목표 성능을 달성하기 위해서 전처리(`IMG_SIZE`, `SCALING`) 조정, 모델 수정(`KERNEL_SIZE`, `CHANNEL_SIZE`, `FC_SIZE`), 학습 하이퍼 파라미터(`EPOCH_NUM`, `BATCH_SIZE`, `LEARNING_RATE`, `OPTIMIZER`) 조정, 과적합 억제 및 초기화 기법(`Dropout`, `Weight decay`, `Weight Initialization`) 활용, `데이터 증강 기법 적용` 등 어떤 방법을 활용하여도 좋습니다.
# 
...
# 
# 
# `accuracy` 측정 결과 정확도가 **0.65 이상**이면 100점입니다.
# 
# (부분점수 있음)
