...
- Case 01. 광석 처리 공단에서의 이산화규소 불순도 예측
    ...
    - [Case 1-2] 회귀 의사결정 나무 모델을 활용한 불순도 예측_
...
- Case 02. 반도체 공정 데이터를 활용한 공정 이상 예측
    - [Case 2-1] 로지스틱 분류 모델을 활용한 공정 이상 예측
    - [Case 2-2] 나이브베이즈 분류 모델을 활용한 공정 이상 예측
    - [Case 2-3] 분류 의사결정 나무 모델을 활용한 공정 이상 예측
    - [Case 2-4] SVM 모델을 활용한 공정 이상 예측
    - [Case 2-5] 다층 퍼셉트론 모델을 활용한 공정 이상 예측
    - [Case 2-6] KNN 모델을 활용한 공정 이상 예측

- Case 03. 제품 감성 분석 (Product Sentiment Analysis)을 위한 자연어처리
    - [Case 3-1] RNN 모델을 활용한 텍스트 감성 분류
    - [Case 3-2] Word2Vec와 FastText 모델을 활용한 단어 임베딩
    - [Case 3-3] 사전 학습된 임베딩 모델을 활용한 감성 분석
    - [Case 3-4] BERT 모델을 활용한 감성 분석

- Case 04. 품질 검증을 위한 생산라인 파손 제품 이미지 분류
    - [Case 4-1] LeNet 모델을 활용한 파손 제품 이미지 분류
    - [Case 4-2] ResNet 모델을 활용한 파손 제품 이미지 분류
    - [Case 4-3] 이미지 데이터 증강 기법을 활용한 파손 제품 이미지 분류
    - [Case 4-3] 이미지 데이터 증강 기법을 활용한 파손 제품 이미지 분류
